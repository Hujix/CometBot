...
public class Purpose implements Command {
	...
	public void run(MessageReceivedEvent event) throws Exception {
		...
		choices.add("Discord DJ");
		choices.add("Who knows, probably codedcosmos");
		choices.add("Reduce entropy");
		choices.add("Complete the hardest challenge of all... When I figure out what it is I will let you know");
		choices.add("To get as many .goodbot's as I can");
		choices.add("To help out");
